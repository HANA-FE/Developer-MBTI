...
const QUESTION = [
  null, // 0번 인덱스는 비워두어 1번부터 시작하도록 함
  {
    ...
    image: Q1,
    answers: [
      { type: 'J', text: '협업툴(노션, 지라 등)을 일단 켜서 오늘 해야 할 일을 정리해 봐야지!' },
      { type: 'P', text: '내 머리 속에 다 있지~ 음 이것부터 하면 되겠다!' },
    ],
  },
  {
    type: 'PJ',
    ...
    image: Q2,
    answers: [
      { type: 'J', text: 'Daily, Weekly 별로 과업을 관리하고 역할을 분담해야겠다. 모두 모여보세요~' },
      { type: 'P', text: '대략적인 데드라인만 정해야겠다. 어차피 프로젝트는 계획대로 안 돼…' },
    ],
  },
  {
    type: 'PJ',
    ...
    image: Q3,
    answers: [
      { type: 'J', text: '"몇 시까지 해야 하는 거지? 빠르게가 언제일까?"라고 생각하며 스트레스 받는다.' },
      { type: 'P', text: '"(바로 시작해야지) 네~" ^___^' },
    ],
  },
  {
    type: 'EI',
    ...
    image: Q4,
    answers: [
      { type: 'E', text: '회식이라니 재밌겠다! 참석해서 모두와 친해져야지 ~' },
      { type: 'I', text: '헉 너무 많은 사람은 불편해… 나는 차근차근 친해질래...' },
    ],
  },
  {
    type: 'EI',
    ...
    image: Q5,
    answers: [
      { type: 'E', text: '더 많은 얘기를 하고 친해질 수 있는 기회다! 맛있는 것도 먹고 사람도 알고 ~' },
      { type: 'I', text: '불편한 상태에서 밥을 먹으면 체할 수도 있으니 나는 일단 집에 간다 해야겠다...' },
    ],
  },
  {
    type: 'EI',
    ...
    image: Q6,
    answers: [
      { type: 'E', text: '피곤하지만 주말에나 약속을 잡을 수 있으니까 일단 나간다.' },
      { type: 'I', text: '주중에 열심히 나갔으니까 주말에는 집에서 푹 쉰다.' },
    ],
  },
  {
    type: 'TF',
    ...
    image: Q7,
    answers: [
      { type: 'T', text: '"세미콜론 빠뜨렸잖아;;;;;;;;" (로그 확인하고 냉정하게 지적)' },
      { type: 'F', text: '"헉 ㅠㅠ 혹시 ; 때문인 거 아니야?? 괜찮아... 괜찮아... 우리 다 그런 실수 해...😢"' },
    ],
  },
  {
    type: 'TF',
    ...
    image: Q8,
    answers: [
      { type: 'T', text: '"디버깅 해봤어?" (가차 없이 현실 직시)' },
      { type: 'F', text: '"헉 ㅠㅠ 너무 힘들지? 뭐가 문제일까? 같이 한 번 보자! 😭"' },
    ],
  },
  {
    type: 'TF',
  ...
  },
  {
    ...
    image: Q10,
    answers: [
      { type: 'S', text: '여러 데이터들을 분석한 뒤 의견을 제시한다.' },
      { type: 'N', text: '재밌는 아이디어가 떠오르면 즉흥적으로 제시한다.' },
    ],
  },
  {
    type: 'SN',
