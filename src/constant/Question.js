...
const QUESTION = {
  ...
  2: {
    type: 'PJ',
    text: '프로젝트 일정을 관리해야 한다면 어떻게 할 것인가?',
    image: Q2,
    answers: {
  ...
  3: {
    type: 'PJ',
    text: "상사가 '급한 일이니 빠르게 처리해주세요'라고 했다.",
    image: Q3,
    answers: {
  ...
  4: {
    type: 'EI',
    text: '팀 프로젝트 시작 전, 사기 충전을 위해 다 같이 화이팅 회식을 하기로 했다. 참석할 것인가?',
    image: Q4,
    answers: {
  ...
  5: {
    type: 'EI',
    text: '오늘 하루 할 일을 끝낸 후, 남아서 공부한 사람들끼리 저녁을 먹으러 가자고 한다면?',
    image: Q5,
    answers: {
  ...
  6: {
    type: 'EI',
    text: '주중에 열심히 일한 당신, 주말엔 어떻게 시간을 보낼 것인가?',
    image: Q6,
    answers: {
  ...
  7: {
    type: 'TF',
    text: '팀원이 버그를 못 고쳐서 울고 있는데, 알고 보니 ;(세미콜론) 문제였다. 나는?',
    image: Q7,
    answers: {
  ...
  8: {
    type: 'TF',
    text: "팀원이 갑자기 '이거 왜 안 되는지 모르겠어요!'라고 한다. 나는?",
    image: Q8,
    answers: {
  ...
  9: {
    type: 'TF',
    text: "팀장이 '이거 일정 앞당길 수 있어요?'라고 묻는다. 나는?",
    image: Q9,
    answers: {
